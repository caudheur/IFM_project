...
var willingnessToTryNewClothes = 0;
var diviser = 0;
var factors = []; // addFactor("Mood", 60, 3);
...
for (var _i = 0, _factors = factors; _i < _factors.length; _i++) {
  var factor = _factors[_i];
...
var tableHeaders = ["name", "value", "coef"];
var HTMLTable = "<table><tr>";

for (var _i2 = 0, _tableHeaders = tableHeaders; _i2 < _tableHeaders.length; _i2++) {
  var header = _tableHeaders[_i2];
  HTMLTable += "<th>" + header + "</th>";
}

HTMLTable += "</tr>";

for (var _i3 = 0, _factors2 = factors; _i3 < _factors2.length; _i3++) {
  var _factor = _factors2[_i3];
  HTMLTable += "<tr>";
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      HTMLTable += "<td>" + _factor[_header] + "</td>";
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
document.getElementById("resultsPercent").innerHTML = Math.round(willingnessToTryNewClothes);
